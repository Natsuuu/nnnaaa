...
client = LINE("Ewa9J6M8USOnf1NV9pW6.a51M3+Gk88H2jbkIVL52zG.CMcijrQdAsDFYI+wp9sM++1v7oNDInD932QNvBYtfA8=")
client.log("Auth Token : " + str(client.authToken))
KB = LINE("Ew8b5gIdQtanaJ45J6m2.untHL8qTBS4KXZII1WIyeG.WzIPPApRluJjPWDFV02ppdBR4RUYGDUEmlrEKiWTAkg=")
client.log("Auth Token : " + str(KB.authToken))
KC = LINE("EwhPNEJ3QMnDDHTd75u5.7R/mj1CHAYNrTygiXRE8Lq.PDHK90a5S+vOmydAt/4Oqita3XSehIuzYcJO5Zr21p4=")
client.log("Auth Token : " + str(KC.authToken))
KD = LINE("EwTueuDfio3NiPVPBCkd.lrqUwX5AeToRMjnBOgWcNq.AWOHEpqGLfyurXycolGF2X8D3sKQO2vm8bONi9DSr6A=")
client.log("Auth Token : " + str(KD.authToken))
KE = LINE("EwVw43zkOonJ9HGCf86e.EAJRUKwTjYEm48/0KX0mxG./aQdMtOuHwq+l1yyxc9CbzZdIoVwbiqs8O6O0sLTfPM=")
client.log("Auth Token : " + str(KE.authToken))
KF = LINE("EwJBt6JwsEXs3Tg0RFa3.PXxVoKegXtIiQ1v4WbUmiW.kWnLEujvUFvlqK/IsCVS7G4MYeRh4ORq6NfyqEJudto=")
client.log("Auth Token : " + str(KF.authToken))
KG = LINE("EwbjtM0vxkfSSE3iSXD0.K3+hRz0vYzqZRueEHTmW8a.26k8I9QVOgmm7/KKN0S8i8janfpcDo8pwnePAOIa9+E=")
client.log("Auth Token : " + str(KG.authToken))
KH = LINE("EwJ7dRxlFmvTfyCXA7L9.2Qz3M2q6TaqxIhzPAQaSMq.AkIdOtcHvjOUBjmWo64fpQOhb8aVZBkUsHFvJ3Ct/+Y=")
client.log("Auth Token : " + str(KH.authToken))
KI = LINE("EwNwnQkWQRDnL0TSTuK6.iJduZ1MiG2pm4+veQogk1G.i9VMNCdnfxnF+w0s+EW+rvoNbDTd4UA87qXkUcOBS0c=")
client.log("Auth Token : " + str(KI.authToken))
KJ = LINE("EwxXtyICefA8j9Xpg781.aVTNWw9Djfsbv5gWo8Cl8q.SjBAdhNE5oif9oESURnrjp+GH61AtuZy/xB6lp5FBUY=")
client.log("Auth Token : " + str(KJ.authToken))
KK = LINE("EwmcyobhDIigf294JTOd.qHhq/Cl/td+ZILtuK79Z+q.Ll1BTf5a0y5fOTLOcOnHexJ6j+xXYo+pa9sNi8EkUno=")
client.log("Auth Token : " + str(KK.authToken))
KL = LINE("EwGv4QSJ5A7WSdFs9opa.ELQkNHQtk6pJZe1XvZtiQG.ihMG3nnLjnJ5yjheSPs2ewdsaudTkm1Bwtcy4XzAiJQ=")
client.log("Auth Token : " + str(KL.authToken))
KM = LINE("EwnQL1icz6WwJw3L4iK9.vQMo/A1Ck97/oALSyJARcq.xqvYBbQtYn8lzA/oYDBXw+8NnlJ7ogc0zgyJMel2cRA=")
client.log("Auth Token : " + str(KM.authToken))
KN = LINE("EwdZAqNtSRK2sX8ikdTb.6/QH7FvRpWk6w6QcOI3dYW.acGh+4crRS8ZbDvQkd19ZegL3NPbhUFPGBTIWVkx3c0=")
client.log("Auth Token : " + str(KN.authToken))
KO = LINE("EwuCRQFtWUu1fGVD51Ha.zeJF68JQfg9JHExOG71XkG.kG4dzQaJzSqdy7Su4iFprhkpfdNypdHcRDIdT1D+idc=")
client.log("Auth Token : " + str(KN.authToken))
...
BA = LINE("EwgbDE9e1VTJXSf1WQ92.fpkM0sM0Mn6KNs06Z1kSiG.st2iCoQe8Wb7X9MPx6fH/hgMoGL3FObz/clmgmiTFQY=")
client.log("Auth Token : " + str(BA.authToken))
BB = LINE("EwUkcRrFkxkGUOL26sv5.D1498sUQrJucgzqPGm6Hbq.jKPO1aIz7AnTG1PLuM3g6wOpCSFDbLgxMbp7ePS7C0Q=")
client.log("Auth Token : " + str(BB.authToken))
BC = LINE("Ew2jkxwxVensJZCPnEM0.IbugdJmH9mG2x9CA4fVIia.bet1xb/7gjMtVBesiNQL6/jQJf3GW8OPzI2OVJ2cwm8=")
client.log("Auth Token : " + str(BC.authToken))
clientPoll = OEPoll(client)


BOT=[client,KB,KC,KD,KE,KF,KG,KH,KI,KJ,KK,KL,KM,KN,KO]
KAC=[KB,KC,KD,KE,KF,KG,KH,KI,KJ,KK,KL,KM,KN,KO]
KBC=[BA,BB,BC]
...
pE = KE.getProfile();pF = KF.getProfile();pG = KG.getProfile();pH = KH.getProfile();pI = KI.getProfile();pJ = KJ.getProfile();pK = KK.getProfile();pL = KL.getProfile();pM = KM.getProfile();pN = KN.getProfile();pO = KO.getProfile()
...
aws = LINE("EwT9zwwW2uBznKcJR4K2.LmhYcFeF5IwkvLfaVCcyKG.WptEHm1cn09fJPw+Lid9x9HoGph0uhnROYlQ+kKix5I=")
awe = LINE("EwWHFHuiFQs9By1RHSGc.HAKFoQn4xuCPCHQ+lrL03a.RDKFBFB2hSmxG9oB1y+doPX1TFy1QRpJjmTYp7rOx9U=")
...
ki = [pB.mid,pC.mid,pD.mid,pE.mid,pF.mid,pG.mid,pH.mid,pI.mid,pJ.mid,pK.mid,pL.mid,pM.mid,pN.mid,pO.mid]
bots = [profile.mid,pB.mid,pC.mid,pD.mid,pE.mid,pF.mid,pG.mid,pH.mid,pI.mid,pJ.mid,pK.mid,pL.mid,pM.mid,pN.mid,pO.mid]
#print wait
            ...
            try:
                if op.param2 in haveP:
                    ...
                    try:
                        ...
                        for x in KBC:
                            x.acceptGroupInvitationByTicket(op.param1,Ticket)
                        boot = random.choice(KBC)
                        boot.kickoutFromGroup(op.param1,[op.param2])
                        for x in KBC:
                            x.leaveGroup(op.param1)
                    except:
                        try:
                            bot = random.choice(KAC)
                            G = bot.getGroup(op.param1)
...
タイムラインを共有、ノート投稿、アルバム作成、連絡先をおくるとその情報を表示します"""
                ...
                if (msg._from in haveP):
                    ...
                    KK.sendMessage(msg.to,"点呼11!")
                    KL.sendMessage(msg.to,"点呼12!")
                    KM.sendMessage(msg.to,"点呼13!")
                    KN.sendMessage(msg.to,"点呼14!")
                    KO.sendMessage(msg.to,"点呼15!")
